/**
 * IHotelFlow_SearchHotelsByDestinationIds_WSFault_FaultMessage.java
 *
...
public class IHotelFlow_SearchHotelsByDestinationIds_WSFault_FaultMessage
    extends java.lang.Exception {
    private static final long serialVersionUID = 1448296970584L;
    private com.qinjiance.tourist.task.support.tourico.hotel.HotelFlowStub.WSFaultE faultMessage;

    public IHotelFlow_SearchHotelsByDestinationIds_WSFault_FaultMessage() {
        super("IHotelFlow_SearchHotelsByDestinationIds_WSFault_FaultMessage");
    }
